...
public class Run {
    public static void main(String[] args) {
            ...
            String json=userService.loadJson("https://academy.hybridit.sk/java/Data/userjsondata.json");
            userService.parseJson(json);
           // System.out.println(json);
            //userService.parseCSV("./files/data.csv");
            ...
            do {
                ...
                List<User> dvestoCode=userService.filterByStatusCode(new StatusCode(200,""));
                List<User> styristoCode=userService.filterByStatusCode(new StatusCode(400,""));
                List<User> styristojednaCode=userService.filterByStatusCode(new StatusCode(401,""));
           ...
           // User vyherca=userService.zrebuj();
            //System.out.println("Vyherca: "+vyherca.prezentujSa());
    }
}